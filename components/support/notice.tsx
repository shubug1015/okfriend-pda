...
export default function Notice({
  ...
  return (
    <Link href={`/support/notice/detail/${id}`}>
      <a>
        {/* pc 버전 */}
        <div
          className={cls(
        ...
        >
            ...
            {type === 'notice' ? (
              ...
              >
                <path
                  ...
                  fill='#ff6161'
                />
                <rect x='7' y='7' width='10' height='10' fill='#ff6161' />
              </svg>
            ) : (
              num
            )}
          ...
          {/* <div className='flex w-[8.5%] justify-center'>
            <span
              className={cls(
                type === 'notice'
                  ? 'rounded bg-[#ff6161] px-3.5 py-0.5 text-white'
                  : '',
                ' text-xs font-medium'
              )}
            >
        ...
        >
          <div className='flex items-center justify-between'>
            <div className='flex items-center space-x-1.5'>
              {type === 'notice' && (
                <div className='rounded bg-[#ff6161] px-1.5 py-0.5 text-[0.688rem] font-medium text-white'>
                  공 지
                </div>
              )}
